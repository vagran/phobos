...
typedef enum {
	...
	CPUID_EFEAT_IA64 =		(1 << 29), /* Intel(c) 64 Architecture available if 1 */
} CPUIDBits;
...
typedef enum {
	...
	MTRR_N16K =				16,
	MTRR_N4K =				64,
	MTRR_CAP_WC =			0x0000000000000400UL,
	MTRR_CAP_FIXED =		0x0000000000000100UL,
	MTRR_CAP_VCNT =			0x00000000000000ffUL,
	MTRR_DEF_ENABLE =		0x0000000000000800UL,
	MTRR_DEF_FIXED_ENABLE =	0x0000000000000400UL,
	MTRR_DEF_TYPE =			0x00000000000000ffUL,
	MTRR_PHYSBASE_PHYSBASE =	0x000ffffffffff000UL,
	MTRR_PHYSBASE_TYPE =	0x00000000000000ffUL,
	MTRR_PHYSMASK_PHYSMASK =	0x000ffffffffff000UL,
	MTRR_PHYSMASK_VALID =	0x0000000000000800UL,
} MTRRConsts;
...
typedef enum {
	...
	MCG_CTL_ENABLE =		0xffffffffffffffffUL,
	MCG_CTL_DISABLE =		0x0000000000000000UL,
	MC_STATUS_MCA_ERROR =	0x000000000000ffffUL,
	MC_STATUS_MODEL_ERROR =	0x00000000ffff0000UL,
	MC_STATUS_OTHER_INFO =	0x01ffffff00000000UL,
	MC_STATUS_PCC =			0x0200000000000000UL,
	MC_STATUS_ADDRV =		0x0400000000000000UL,
	MC_STATUS_MISCV =		0x0800000000000000UL,
	MC_STATUS_EN =			0x1000000000000000UL,
	MC_STATUS_UC =			0x2000000000000000UL,
	MC_STATUS_OVER =		0x4000000000000000UL,
	MC_STATUS_VAL =			0x8000000000000000UL,
} MCRegConsts;
