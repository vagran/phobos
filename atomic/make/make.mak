...
COMPILE_FLAGS += -pipe -Wlong-long -Werror -Wall -fno-stack-protector  -fno-builtin \
...
LINK_FLAGS += --no-omagic -z common-page-size=0x1000 --defsym LOAD_ADDRESS=$(LOAD_ADDRESS)
