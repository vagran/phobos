/*
 * /phobos/kernel/sys/elf_common.h
 * $Id$
 *
...
/* Values for e_machine. */
	...
	EM_ST9PLUS =	67,		/* STMicroelectronics ST9+ 8/16
				   microcontroller. */
...
/* Values for d_tag. */
	...
	DT_NEEDED =	1,		/* String table offset of a needed shared
				   library. */
	...
	DT_SONAME =	14,		/* String table offset of shared object
				   name. */
...
/* Values for DT_FLAGS_1 */
	DF_1_BIND_NOW =	0x00000001,		/* Same as DF_BIND_NOW */
	DF_1_GLOBAL =	0x00000002,		/* Set the RTLD_GLOBAL for object */
	DF_1_NODELETE =	0x00000008,		/* Set the RTLD_NODELETE for object */
	DF_1_NOOPEN =	0x00000040,		/* Do not allow loading on dlopen() */
	DF_1_ORIGIN =	0x00000080,		/* Process $ORIGIN */
...
#define	VER_NEED_WEAK	(1u << 15)
	VER_NEED_HIDDEN =	VER_NDX_HIDDEN,
...
/*	Name			Value	   Field	Calculation */
	...
	R_MIPS_GOTHI16 =	21,		/* GOT HI 16 bit */
	R_MIPS_GOTLO16 =	22,		/* GOT LO 16 bit */
	R_MIPS_CALLHI16 =	30,		/* upper 16 bit GOT entry for function */
	R_MIPS_CALLLO16 =	31,		/* lower 16 bit GOT entry for function */
